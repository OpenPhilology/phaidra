...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_appuser', (
            ...
            ('lang', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('unit', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('lesson', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        m2m_table_name = db.shorten_name(u'app_appuser_groups')
        ...
        m2m_table_name = db.shorten_name(u'app_appuser_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('appuser', models.ForeignKey(orm[u'app.appuser'], null=False)),
        ...
        db.create_table(u'app_textbook', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('source_lang', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('target_lang', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal(u'app', ['Textbook'])

        # Adding model 'Unit'
        db.create_table(u'app_unit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('textbook', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Textbook'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('color', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('graphic', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'app', ['Unit'])

        # Adding model 'Lesson'
        db.create_table(u'app_lesson', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Unit'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'app', ['Lesson'])

        # Adding model 'Slide'
        db.create_table(u'app_slide', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lesson', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Lesson'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('smyth', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('task', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'app', ['Slide'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'app_appuser_groups'))

        # Removing M2M table for field user_permissions on 'AppUser'
        db.delete_table(db.shorten_name(u'app_appuser_user_permissions'))

        # Deleting model 'Textbook'
        db.delete_table(u'app_textbook')

        # Deleting model 'Unit'
        db.delete_table(u'app_unit')

        # Deleting model 'Lesson'
        db.delete_table(u'app_lesson')

        # Deleting model 'Slide'
        db.delete_table(u'app_slide')
